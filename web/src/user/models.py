...
class User(Base):
    ...
    def __init__(self, username=None, hostname=None, domain=None, source_ip=None, session_id=None,\
        server_challenge=None, org_name=None, ntproofstr=None, ntlm_response=None):
